...
const NOT_DONE_ICON = String.fromCodePoint(Number('0x1F7E0'));
const DONE_ICON = String.fromCodePoint(Number('0x2705'));
...
const useAndStartPersister = (store: Store | undefined) =>
